...
- [x] Clarify Project Requirements
	<!-- Python project for RAG using LangChain -->

- [x] Scaffold the Project
	<!-- Created requirements.txt, rag.py (class-based), data folder, .env, README.md, .gitignore -->

- [x] Customize the Project
	<!-- Implemented RAGSystem class, loading from data/*.docx, using GPT-4o mini, with hallucination control -->
